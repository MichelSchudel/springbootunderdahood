...
import static nl.greetinglibrary.GreeterConfigParams.*;
...
public class GreeterAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public GreeterWrapper greeterwrapper(GreetingConfig greetingConfig) {
        return new GreeterWrapper(greetingConfig);
    }
}
